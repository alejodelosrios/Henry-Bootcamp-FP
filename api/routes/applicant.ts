...
applicantRouter.get(
  ...
  applicantController.applicantById
);
...
applicantRouter.put(
  "/favorite",
  isAuthorized(["admin", "applicant"]),
  applicantController.addfavorite
);
